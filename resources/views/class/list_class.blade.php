            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Class Data</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card card-table">
                    <div class="card-body">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="page-title">Class Data</h3>
                                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                            <div class="actions">
                                                ...
                                                <a class="btn btn-sm bg-danger-light class_delete" data-bs-toggle="modal" data-bs-target="#classDelete">
...
{{-- Model class delete --}}
<div class="modal fade contentmodal" id="classDelete" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body">
                <form action="{{ route('class/delete') }}" method="POST">
                    ...
                    <div class="delete-wrap text-center">
                        ...
                        <input type="hidden" name="id" class="class_id" value="">
...
@section('script')
    ...
    <script>
        $(document).on('click', '.class_delete', function () {
            ...
            $('.class_id').val(_this.find('.id').text());
        });
    </script>
@endsection
