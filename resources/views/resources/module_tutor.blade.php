...
<div class="student-group-form">
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="search-student-btn">
                    <a href="{{ route('resources_a/upload_module_tutor/page') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Add</a>
                    </div>
                </div>
...
<table class="table">
        ...
        <tbody>
            ...
            @foreach($moduleTList as $Index => $resource)
            <tr>
                ...
                <td class="text-end">
                    <div class="actions">
                        ...
                        @if($resource->uploaded_by == Auth::id())
                            <a href="{{ url('resources_a/editModuleTutor/'. $resource->res_id)}}" class="btn btn-sm bg-danger-light"><i class="feather-edit"></i></a>
