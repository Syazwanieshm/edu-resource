...
<div class="content container-fluid">
    ...
    <div class="student-group-form">
        <form method="GET" action="{{ url('resources_a/textbook/page') }}">
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="search-student-btn">
                        <a href="{{ route('resources_a/upload_tb/page') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Add</a>
                    </div>
                </div>
            </div>
        </form>
            ...
            <img class="card-img-top" src="{{ URL::to('assets/img/biologyf4.jpeg') }}" alt="Card image cap">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mt-auto d-flex justify-content-between">
                        <a href="{{ url('resources_a/editTb/' . $resource->res_id) }}" class="btn btn-primary">Edit</a>
                        <a href="{{ url('resources_a/textbook/delete/' . $resource->res_id) }}" class="btn btn-danger">Delete</a>
                    </div>
                </div>
            </div>
        @endforeach
