...
<div class="container">
    ...
    <form id="uploadForm" action="{{ route('resources_a/uploadModule') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <a href="{{ route('resources_a/module/page') }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>
