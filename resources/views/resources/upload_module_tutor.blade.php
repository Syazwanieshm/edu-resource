...
<div class="container">
    ...
    <form id="uploadForm" action="{{ route('resources_a/uploadModuleTutor') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-group">
            <label for="fileInput">Upload Module:</label>
        ...
        <input type="hidden" name="type" value="MODULE"> <!-- Add this hidden input field -->
        <button type="submit" class="btn btn-primary">Upload</button>
        <a href="{{ route('resources_a/moduleTutor/page') }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>

<script>
    document.getElementById('uploadModule').addEventListener('submit', function(event) {
        let isValid = true;
