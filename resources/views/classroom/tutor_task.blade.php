...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <ul class="nav">
            <li class="nav-item"><a class="nav-link active" href="{{ route('subclass_t/main/page') }}">Announcement</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('subclass_t/material/page') }}">Materials</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('subclass_t/task/page') }}">Task</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('subclass_t/review/page') }}">Review</a></li>
        </ul>
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group local-forms">
                            <form action="{{ route('subclass_t/task/page') }}" method="GET">
                    ...
                    <div class="col-lg-2">
                        <div class="search-student-btn">
                            ...
                            <a class="dropdown-item" href="{{ route('tasks.create') }}">Tasks</a>
...
<div class="col">
    <h3 class="page-subtitle"> {{ $selectedTopicName }}</h3>
        ...
        @foreach($taskTutor as $task)
      

<div class="container clickable-card" data-url="{{ route('task.view', ['id' => $task->id]) }}">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-1">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addTopicForm" action="{{ route('tasks.storeTopic') }}" method="POST">
                    @csrf
