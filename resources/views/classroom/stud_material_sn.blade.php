...
<div class="page-wrapper">
    ...
    <li class="nav-item">
        ...
        <a class="nav-link active" href="{{ route('subclass/main/sn') }}">Announcement</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ route('subclass/material/sn') }}">Materials</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ route('subclass/task/sn') }}">Task</a>
    </li>
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group local-forms">
                            <form action="{{ route('subclass/material/sn') }}" method="GET">
