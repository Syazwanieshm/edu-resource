...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">English</h3>
                    <ul class="breadcrumb">
    ...
    <li class="nav-item">
        ...
        <a class="nav-link active" href="{{ route('subclass/main/page') }}">Announcement</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ route('subclass/material/page') }}">Materials</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ route('subclass/task/page') }}">Task</a>
    </li>
                ...
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <div class="form-group local-forms">
                            <form action="{{ route('subclass/material/page') }}" method="GET">
...
<div class="col">
    <h3 class="page-subtitle"> {{ $selectedTopicName }}</h3>
        ...
        @foreach($materialsStud as $material)
      
        <div class="container clickable-card" data-url="{{ route('materialStudent.view', ['id' => $material->id]) }}">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-1">
