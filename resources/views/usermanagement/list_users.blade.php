                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    <a href="{{ route('role/view') }}" class="btn btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="actions">
                                                ...
                                                <a class="btn btn-sm bg-danger-light user_delete" data-bs-toggle="modal" data-id="{{ $list->user_id }}" data-bs-target="#deleteUser">
